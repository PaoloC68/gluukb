...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'QuestionReference.case'
        db.alter_column(u'sugarlink_questionreference', 'case_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['sugarmodels.Case'], unique=True))
        # Adding unique constraint on 'QuestionReference', fields ['case']
        db.create_unique(u'sugarlink_questionreference', ['case_id'])


        # Changing field 'QuestionReference.question'
        db.alter_column(u'sugarlink_questionreference', 'question_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['knowledge.Question'], unique=True))
        # Adding unique constraint on 'QuestionReference', fields ['question']
        db.create_unique(u'sugarlink_questionreference', ['question_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'QuestionReference', fields ['question']
        db.delete_unique(u'sugarlink_questionreference', ['question_id'])

        # Removing unique constraint on 'QuestionReference', fields ['case']
        db.delete_unique(u'sugarlink_questionreference', ['case_id'])


        # Changing field 'QuestionReference.case'
        db.alter_column(u'sugarlink_questionreference', 'case_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sugarmodels.Case']))

        # Changing field 'QuestionReference.question'
        db.alter_column(u'sugarlink_questionreference', 'question_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['knowledge.Question']))
    ...
    models = {
        ...
        u'sugarlink.questionreference': {
            ...
            'case': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['sugarmodels.Case']", 'unique': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'question': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['knowledge.Question']", 'unique': 'True'})
        },
